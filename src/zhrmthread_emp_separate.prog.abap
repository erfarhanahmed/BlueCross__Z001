...
TYPES: BEGIN OF TY_EMPOYEE,
         ...
         DATE_OF_INTIMATION_ACCEPTE TYPE STRING,
         NOTICEPERIOD               TYPE STRING,
         SHORT_NOTICE               TYPE STRING,
         FREEZE_SALARY              TYPE STRING,
       END OF TY_EMPOYEE.
...
START-OF-SELECTION.
  ...
  LV_SP  = |[employeeExit] 'bclpl','{ LV_DATE_LOW }','{ LV_DATE_HIGH }'|.
  LV_EMP = ''.
  ...
  PERFORM EMP_SEPARATION      CHANGING GT_EMPLOYEE.
...
*& <--  p2        text
*&---------------------------------------------------------------------*
FORM EMP_SEPARATION  CHANGING CT_EMPLOYEE TYPE TY_EMPLOYEE_TAB..
